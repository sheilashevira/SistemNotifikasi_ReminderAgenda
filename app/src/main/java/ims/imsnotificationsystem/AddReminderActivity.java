...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Menginisialisasikan tampilan per variabel
        ...
        //Default value
        mActive = "true"; //Kalo dia aktif true, kalo nonaktif false
        mRepeat = "true"; //Kalo dia aktif true, kalo nonaktif false
        mRepeatNo = Integer.toString(1);
        mRepeatType = "Hour"; //Tampilan hour yang muncul pas baru nambah data
    ...
    //On clicking tombol interval repetition
